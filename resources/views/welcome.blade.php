...
<main>
    ...
    <section class="hero-section">
        <div class="hero-content">
            ...
            <p class="hero-subtitle">Join thousands of learners discovering knowledge, guided by timeless heritage and expert mentors.</p>
    ...
    <section class="courses-section">
        <div class="container">
            ...
            <div class="courses-filter" style="margin-bottom:2rem; text-align:center;">
                <label for="gradeFilter" style="font-weight:600; color:#243a6b; margin-right:10px;">Filter by Grade:</label>
                <select id="gradeFilter" style="padding:8px 16px; border-radius:8px; border:2px solid #d4af37; font-size:1rem;">
                    <option value="all">All Grades</option>
                    <option value="first-secondary">First Secondary</option>
                    <option value="third-prep">3rd Prep</option>
                </select>
            </div>
            <div class="courses-grid" id="coursesGrid">

                <div class="course-card" data-grade="first-secondary">
                    <div class="course-image">
                        <img src="imgs/maths.jpg" alt="Mathematics">
                    </div>
                    <div class="course-content">
                        <div class="course-header">
                            <h3>Math</h3>
                        </div>
                        <p>Master the ancient art of numbers and logic</p>
                        <div class="course-meta">
                            <span class="instructor">Dr. Ahmed Hassan</span>
                        </div>
                    </div>
                </div>
                <div class="course-card" data-grade="third-prep">
                    <div class="course-image">
                        <img src="imgs/science.jpg" alt="Science">
                    </div>
                    <div class="course-content">
                        <div class="course-header">
                            <h3>Science</h3>
                        </div>
                        <p>Explore the mysteries of the natural world</p>
                        <div class="course-meta">
                            <span class="instructor">Dr. Sarah Johnson</span>
                        </div>
                    </div>
                </div>
                <div class="course-card" data-grade="first-secondary">
                    <div class="course-image">
                        <img src="imgs/language.jpg" alt="Languages">
                    </div>
                    <div class="course-content">
                        <div class="course-header">
                            <h3>Languages</h3>
                        </div>
                        <p>Unlock the power of communication</p>
                        <div class="course-meta">
                            <span class="instructor">Prof. Maria Rodriguez</span>
                        </div>
                    </div>
                </div>

            </div>
{{--            <button style="padding:8px 16px; border-radius:8px; border:2px solid #d4af37; font-size:1rem; background: #1a2a4a;--}}
{{--    color: #f5deb3; margin-top: 2rem;--}}
{{--    text-align: center; cursor:pointer">Load More&nbsp;&nbsp;↓</button>--}}
        </div>
    </section>
                ...
                <div class="wisdom-content">
                    <div class="wisdom-text">
                        <p class="hero-subtitle">
                            Th𝕆th Gate blends the legacy of ancient Egyptian scholarship with modern pedagogical practice — delivering rigorous courses, expert mentorship, and a nurturing learning environment for the students of today.
                        </p>
