            ...
            <div class="course-content-wrapper">
                ...
                <div class="video-main-area">
                    <div class="video-container">
                        <video controls oncontextmenu="return false;" style="max-width: 775px; max-height: 450px;">
                            <source src="{{ asset($currentLecture->video) }}" type="video/mp4">
                        ...
                        <div class="video-info">
                            ...
                            @else
                                <button class="quiz-btn"
                                    onclick="window.location.href='{{ route('exam.prepareExam', [$course->id, $currentLecture->id]) }}'">
                                    <span class="quiz-icon">📝</span>
                                    Take Quiz
                                </button>
                            @endif
